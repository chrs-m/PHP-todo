...
<article class="px-6 py-6 lg:grid lg:justify-center">
    ...
    <form action=" app/users/signup.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input class="form-control block shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline placeholder:text-xs" type="password" name="confirm-password" id="confirm-password" placeholder="Confirm your passowrd" required>
            <small class="form-text text-xs text-gray-500 px-2 italic">Please provide your choosen password again.</small>
        </div>
