    ...
    <form class="edit-post-container" action="/app/tasks/edit.php" method="post" enctype="multipart/form-data">
        <div class="form-container">
            ...
            <div class="create-task">
                <select class="task-list focus:invalid:border-pink-500 shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" name="dropdown-task-id" required>
                ...
                <small class="block text-xs italic mb-3">Enter the new title.</small>
                ...
                <small class="block text-xs italic mb-3">New details? (optional)</small>
