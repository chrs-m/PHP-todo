...
<section class="px-8 pt-6 pb-8 mb-4">
    <form class="edit-list-container" action="/app/lists/edit.php" method="post" enctype="multipart/form-data">
        <div class="form-container">
            ...
            <select class="task-list bg-white focus:invalid:border-pink-500 shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" name="dropdown-list-id" required>
            ...
            <div class="edit-list">
                ...
                <input class="description-field focus:invalid:border-pink-500 block shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" type="text" name="new-list-description" placeholder="New list name"></input>
    ...
    <form class="edit-post-container" action="/app/tasks/edit.php" method="post" enctype="multipart/form-data">
        <div class="form-container">
            ...
            <div class="create-task">
                <select class="task-list bg-white focus:invalid:border-pink-500 shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 mb-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" name="dropdown-task-id" required>
                ...
                <input class="task-title focus:invalid:border-pink-500 shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" type="text" name="new-task-title" required placeholder="Whats your task?"></input>
                ...
                <input class="task-description shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" type="text" name="new-task-description" placeholder="Extra description?"></input>
                <small class="block text-xs text-gray-500 italic px-1 py-1 mb-3">Update details (optional)</small>
                ...
                <select class="task-list bg-white focus:invalid:border-pink-500 shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 mb-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" name="new-task-list">
                    <option value="">--Please choose a list (dropdown menu)--</option>
                    <?php
                    $listName = '';
                    foreach (getAllListsAndTasks($database, $_SESSION['user']['id']) as $userList) :
                ...
                <input class="task-deadline bg-white shadow appearance-none border rounded w-full sm:w-1/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-xs" type="datetime-local" name="new-task-deadline"></input>
