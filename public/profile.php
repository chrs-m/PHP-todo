...
<article class="update-info-container px-6 py-6">
    ...
    <form class="py-6" action="app/users/update/email.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="new-email" class="block text-gray-700 text-sm font-bold mb-2">Enter your new email below</label>
    ...
    <form class="py-6" action="app/users/update/password.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="new-password" class="block text-gray-700 text-sm font-bold mb-2">Choose your new password</label>
        ...
        <div class="mb-3">
            <label for="confirm-new-password" class="block text-gray-700 text-sm font-bold mb-2">Confrim your new password</label>
